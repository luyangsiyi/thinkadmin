<?php /*a:1:{s:81:"/Library/WebServer/Documents/thinkadmin/application/admin/view/content/index.html";i:1574845281;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<script>
    layui.use('table',function () {
        ...
        table.render({
            elem:'#articlelist'
            ,url:'<?php echo url("Content/showlist"); ?>'//传递page和limit参数给后端
        ...
        $('#addarticle').click(function () {
            window.location.href='<?php echo url("Content/addIndex"); ?>';
        });
        ...
        table.on('tool(showarticle)',function (obj) {
            ...
            if(layEvent == 'edit'){
                var url =' <?php echo url("Content/editIndex"); ?>?id='+ data.news_id;//传递id值去表里查询后给编辑页面赋初值,get方法
                location.href=url;
        ...
        $('#addposition').on('click', function() {
            $.ajax({
                ...
                success:function (d) {
                    if(d.status == 1) {
                        dialog.success(d.message,'<?php echo url("Position/index"); ?>');
                    } else {
